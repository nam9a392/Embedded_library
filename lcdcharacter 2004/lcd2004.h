...
#define LCD_OPERATION_MODE						LCD_8_BIT_MODE
#define LCD_CHARACTER_LINES                     4
#define MAX_CHARACTER_OF_LINE                   20U
#define MAX_CHARACTER_OF_DISPLAY                40U
#define LCD_RAMSIZE                             LCD_CHARACTER_LINES * MAX_CHARACTER_OF_DISPLAY

#define LCD_CURRENT_POSITION                    0xffU
